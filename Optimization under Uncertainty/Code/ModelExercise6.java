...
public class ModelExercise6 {
	...
	public ModelExercise6(HashMap<String, Double> ArcCap, double[] mean, HashMap<String, double[][]> Amatrices,
			double[][] distance) throws IloException {
		...
		cplex.exportModel("modelExercise6.lp");
