...
public class ModelExercise7 {
	...
	public ModelExercise7(HashMap<String, Double> ArcCap, double[] mean, HashMap<String, double[][]> Amatrices,
		...
		cplex.exportModel("modelExercise7.lp");
